...
app.controller('ControllerDetail', function($scope) {
    $scope.produk = {
        nama: 'Photoready Eye Contouring Kit - Impressionist',
        merk: 'REVLON',
        ...
        link: 'https://metroindonesia.com/?product=revlon-photoready-eye-contouring-kit-impressionist',
        gambar: '../../assets/makeup3.png'
    };
